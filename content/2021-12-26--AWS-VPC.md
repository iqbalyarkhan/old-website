...
- Go into the WebServer and install apache: `sudo yum install httpd`
- run `sudo service httpd start`
- `cd /var/www/html`
- create a index.html file: echo "<html><body><h1>Hello!</h1></body></html>" > index.html
- Now visit the public address of your WebServer and you should see hello! Don't close this tab
- Now go to Network ACLs in AWS console and check Inbound Rules: You'll see it allows all traffic with rule number 100 and a deny rule after that.
...
- Try associating our public subnet with this NACL and hit save. Go back to the hello page and you'll see there's an error now!
