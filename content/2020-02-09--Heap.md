...
Naive approach: you could merge all lists and then sort them. That would be $O(NlogN)$ using fastest sorting algorithms. However, the elements are already sorted in their respective lists. We can make use of that.
