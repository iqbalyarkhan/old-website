...
Here, we first call the `.clear()` function that removes completely removes the adjacency list for 2. This is the before and after results when `.clear()` is called for say, vertex 2:
