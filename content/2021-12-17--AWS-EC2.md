...
![EC2-Pricing-Options](./images/aws/ec2-pricing-options.png)[Image Credit - Acloud guru](https://acloudguru.com/)
...
- These are good for applications that have flexible start and end times. 
...
(Make sure to update the quality)

<iframe width="1440" height="900" src="https://www.youtube.com/embed/FJJwzWwS1xA?vq=720p60" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<iframe width="1280" height="680" src="https://www.youtube.com/embed/Mv1qvNfg-vI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

From the above, we've generated our access key id and secret access key. We can now go back to our command line and re-run:

```bash
aws s3 ls
```

and get back the buckets we have. We can also create a bucker from the command line like so:
...
## Security Groups
Before we dive in to how security groups work, let's understand a few concpets: There're a few different methods to communicate with a server. You can SSH into it, or you can use HTTP, or HTTPS etc. Depending on the type of server, our communication method changes. 
